...
\title{Thesis Abstract: Conservatism and Over-conservatism in Grammatical Error Correction}
\author{
...
interest recently, notably through 4 
shared tasks the latests being CoNLL 2014\cite{ng2014conll}.
...
a correction faithfully represents the semantics of the source, by measuring the similarity of their semantic structures.
...
\begin{figure}
	...
	\caption{\label{fig:over-conservatism}
		...
		\footnote{The full legend of the correctors did not fit this abstract, if interested, please contact authors}.
		This example figure show that under all measures(other excluded from the abstract), the gold standard references make
...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\com{\section{Over-Conservativism in GEC Systems}\label{sec:formal_conservatism}
...
systems we experiment on in \S\ref{sec:formal_conservatism} and \S\ref{sec:increase-reference}
are over-conservative, they produce few semantically unfaithful sentences. We 
