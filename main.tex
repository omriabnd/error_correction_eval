...
\begin{table}[h!]
  ...
  \begin{tabular}{c|c|c|c||c|c|}
  	\cline{2-6} 
  	& \multicolumn{3}{c||}{Fully aligned} & \multicolumn{2}{c|}{Token analysis}\\ \cline{2-6}
    ...
    Baseline & 0.85 & 0.81 & 0.83 & 0.95 & 0.96
	  \end{tabular}
  \caption{Similarity measures for different mapping, their average and token analysis. For fully aligned similarity score the baseline is the score over two LL annotations and for the Token analysis the translation between English and French. The correction similarity introduces less noise than the different annotators and annotating LL changes even less than translating does.\label{tab:Distances}}
\end{table}
