...
The graphs do show near linear behaviour from $M=9$ or so (after an initial concave behavior),
which indicates that it reflects a reasonable balance between cost and bias.
...
as unlikely as our results in Section \ref{sec2} show that the output of these systems
considerably diverge from NUCLE's references.
...
\oa{We should discuss what number of references of references may be more suitable for a reliable evaluation. maybe 8,9}
