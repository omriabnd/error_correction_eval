...
to the prevalence of similar changes between the source and reference (according to NUCLE).
...
\paragraph{Results:}
Figure \ref{over-conservatism} present our results using the split and concatenate, number of words changed per sentence and Spearman's row measures.
