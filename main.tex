...
measure of fluency (cf. \cite{sakaguchi2016reassessing}), as it only captures
...
{\color{red} Another way to use semantic similarity as an evaluation would be an approach }\lc{The reduction to semantic and error detection is another related way to convert this into an evaluation measure, one without references}
