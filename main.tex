...
similarity of their semantic structures (Section \ref{sec:Semantics}). This approach can be combined with reference-less grammatic evaluation as the one recently proposed in ***.
...
\newcite{napoles2016theres} address the insufficiency of reference-based measures
