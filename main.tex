...
and not the correction's grammaticality. {\color{red}
\newcite{napoles-sakaguchi-tetreault:2016:EMNLP2016} indeed proposed such a measure, suggesting the use of error detection of the correction providing a reference-less grammaticality score}.
...
rather than phrases.\oa{check if they have any empirical evaluation, and if so, mention it
  in a sentence} \newcite{napoles2015ground} compares the system ranking of different correctors inspired by
...
\newcite{napoles2016theres} address the insufficiency of reference-based measures and an evaluation protocol, which is based
on a combination of reference-less grammatical error detection of the correction combined with a reference based measure.
