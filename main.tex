...
More specifically, reference-less machine translation evaluation methods were proposed and shown at the time to be reliable measures \cite{reeder2006measuring,albrecht2007regression,specia2009estimating,specia2010machine,lo2011meant}. Perhaps most similar is the work of \newcite{banchs2015adequacy},
combining semantic and grammatical measures. Despite their similarity, all those methods did not use up to date semantic annotation schemes, if at all or were not automatic.
