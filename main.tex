...
and continue with an empirical assessment of the distribution of corrections for a given sentence (\S \ref{}),
and the effect of $M$ on commonly used RBMs (\S \ref{}).
We discuss the implication of our results in \S \ref{}, concluding that reference-based
