...
no empirical assessment of its sufficiency or its added
value over $M=1$ has been carried out.
The only previous work we are aware of that addressed higher values of $M$
is \cite{napoles-sakaguchi-tetreault:2016:EMNLP2016}, which explored the
correlation between reference-based measures as $M$ ranges between
1 and 20, but ... \oa{what bad thing can we say about them?}
...
Second, we pursue a reference-less semantic evaluation approach which assesses
the extent to which
...
%This approach can be combined with reference-less grammatic evaluation as the one recently proposed by \cite{napoles-sakaguchi-tetreault:2016:EMNLP2016}.}
