...
(\S \ref{sec:formal_conservatism}). {\color{red} 
...
UCCA is motivated by its wider coverage of predicate types, as opposed to MEANT's focus on verbal structures. See \cite{birch2016hume} for a more elaborate comparison. Future work will experiment with a wider variety of semantic representations, both symbolic and distributional (e.g., \cite{cheng2015syntax}).
...
the semantic strctures of the source to corrections of fairly poor quality.
