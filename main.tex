...
and compute their agreement. In order to measure
the faithfulness score for a perfect corrector, we annotate both
...
The measure is an analogue to the DAG F-score measure discussed above, generalized
for the case where $G_s=(V_s,E_s)$ and $G_c=(V_c,E_c)$ do not share their leaf nodes.
...
from the source to the correction and the other way around.
...
results between sources and gold standard corrections tuples as to those obtained
