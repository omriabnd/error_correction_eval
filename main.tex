...
This analysis shows that low coverage is a possible cause for over-conservatism. Ideally, in order to validate this empirically, we should re-train correctors using multiple references, and re-examine their conservatism. However, corpora annotated with more than one correction are scarce. 
