...
mean number of annotators who judged a correction to be valid, where sentences are grouped by the number of times they appear in the data (the gathered corrections), is given in Figure \ref{fig:accuracy_vals}. 
