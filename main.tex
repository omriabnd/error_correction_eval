...
We used \newcite{rozovskaya2016grammatical} 100 best list over CONLL2014 test and chose the output maximizing micro-$F_0.5$ for $M=1,\ldots12$ randomly sampled references. We sampled from \newcite{bryant2015far} together with NUCLE references.
