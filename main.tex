...
Similar results are obtained on the TreeBank of Learner English \cite{yannakoudakis2011new}.
...
Our results show that word changes increase with $M$ (Figure \ref{fig:reranking_word_change}),
while no significant difference is found in word order.
...
systems we experiment on in \S\ref{sec:formal_conservatism} and \S5\ref{sec:increase-reference}
