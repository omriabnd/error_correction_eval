...
Details in Appendix \ref{ap:validity_judgements}.\oa{why C.1?}
...
\begin{figure*}
  ...
  %	 measure values for a perfect system (y-axis)
...
\begin{table}[t]
	...
	\begin{tabular}{c|C{1cm}|cc}
		...
		\multicolumn{1}{c|}{Correction Rate}            & =  & $\downarrow$        & $\uparrow$
	\end{tabular}
...
As a measure of under-correction tendency, we take the ratio between the mean number of corrections produced by the systems and by the references as proposed by {\sc MAEGE} \cite{choshen2018maege}.\oa{find out what experiment was run and add more detail.}
...
using Grammatical Error Detection tools, as did \newcite{asano2017reference}, who added a fluency measure to the grammaticality.
