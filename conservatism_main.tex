...
\paragraph{GLEU.} We repeat the procedure using the mean GLEU sentence score (Figure \ref{fig:F_Ms}), shown to correlate better with human judgments \cite{napoles-sakaguchi-tetreault:2016:EMNLP2016}, results with the GLEU aggregated score are about $2\%$ higher with a similar plateau trend.
