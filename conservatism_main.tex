...
we use crowdsourcing for obtaining a sample from $\mathcal{D}_x$ (see Supplementary  \ref{ap:crowd} for details).
...
references. A more in-depth analysis of SARI's handling of multiple references can be found in Supplementary  \ref{ap:sari-assum}.
