		...
		\begin{subfigure}{1.1\columnwidth}
			...
			\end{subfigure}
				...
				\caption{\label{fig:example}
					Ucca structures of a learner language (top) and correction (bottom) including word alignments (dashed). On the edges are labels and numbers aligned to (top) or indexes (bottom). Precision is 0.78 Recall is 1.0.
				}
			\end{figure}
